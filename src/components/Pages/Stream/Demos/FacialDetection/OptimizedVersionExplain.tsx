...
function EncounteredProblems() {
    ...
    return (
        ...
        <div className="optimizedVersion stream-article">
            ...
            <div className='w-full flex flex-row justify-around items-center'>
                <div className='flex flex-col justify-center items-center'>
                    ...
                    <img alt="OpenCV implementation preview" src={vanilla} className="w-[20vw] rounded-3xl mt-[0.6vw]"></img>
                </div>
                <div className='flex flex-col justify-center items-center'>
                    <div>My implementation (Enhanced)</div>
                    <img alt="Enhanced implementation preview" src={unoptimized} className="w-[20vw] rounded-3xl mt-[0.6vw]"></img>
                </div>
            </div>
            ...
            <div className="flex flex-col items-center ">
                <div className="stream-section-heading">Optimization 1: Reduce frame-time !</div>
            </div>
            ...
            <br></br>
            <div className='flex flex-col items-center'>
                <img alt="Reduced frame-time demo" src={optimized} className="w-[20vw] rounded-3xl"></img>
            </div>
            ...
            <div className="flex flex-col items-center ">
                <div className="stream-section-heading">Optimization 2: Accuracy !</div>
            </div>
            ...
            <div className='stream-code-pill py-[1.2vw] px-[2vw] mt-[0.6vw]'>
            ...
            <div className='flex flex-col items-center'>
                ...
                <img alt="Optimized enhanced demo" src={even_more_optimized} className="w-[20vw] rounded-3xl mt-[0.6vw]"></img>
            </div>
            ...
            <div className='flex flex-col items-center'>
                <div className="stream-section-heading">Comparisons</div>
                <br></br>
                <div className='flex flex-row justify-evenly w-full'>
                    <div className='flex flex-col items-center'>
                        <div>Traditional Method</div>
                        <img alt="Traditional method comparison" src={vanilla} className=" rounded-3xl w-[18vw] mt-[0.6vw]"></img>
                    </div>
                    <div className='flex flex-col items-center'>
                        <div>Enhanced</div>
                        <img alt="Enhanced comparison" src={unoptimized} className="rounded-3xl w-[18vw] mt-[0.6vw]"></img>
                    </div>
                    <div className='flex flex-col items-center'>
                        <div>Optimized Enhanced</div>
                        <img alt="Optimized enhanced comparison" src={even_more_optimized} className=" rounded-3xl w-[18vw] mt-[0.6vw]"></img>
                    </div>
