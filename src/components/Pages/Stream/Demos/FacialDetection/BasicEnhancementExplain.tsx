...
function BoringBasics() {
    ...
    return (
        <div className="basicEnhancement stream-article flex flex-col">
            ...
            <div className=" w-full">
                ...
                <div className="flex flex-col items-center ">
                    <div className="stream-section-heading">{haarCascadeIntro}</div>
                </div>
            ...
            <div className="w-full">
                ...
                <div className=" flex flex-col justify-center items-center">
                    ...
                    <div>
                        <img alt="Forehead Haar feature" src={forehead_feature} className="  w-[12vw] mt-[1vw]"></img>
                    </div>
            ...
            <div className="w-full">
                ...
                <div className=" flex flex-col justify-center items-center">
                    ...
                    <div>
                        <img alt="Eyes Haar feature" src={eyes_feature} className="  w-[12vw] mt-[1vw]"></img>
                    </div>
                    <div className="mt-[1vw]">
                        {haarCascadeExample5}
                    </div>
                    <div className="flex flex-col items-center mt-[3vw]">
                        ...
                        <div>
                            <img alt="Haar cascade visualization" src={Haar_Cascade_Visualization} className="  w-[30vw] mt-[1vw]"></img>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="flex flex-col items-center">
                <div className="stream-section-heading">Limitation</div>
            </div>
            ...
            <div className="flex flex-col justify-center items-center">
                ...
                <div>
                    <img alt="Tilted face limitation example" src={limitation} className="  w-[16vw] mt-[1vw]"></img>
                </div>
            </div>
            ...
            <div className="flex flex-col items-center">
                <div className="stream-section-heading">Solution</div>
            </div>
            ...
            <div className="flex flex-col justify-center items-center">
                ...
                <div>
                    <img alt="Rotation function demonstration" src={rotation} className=" mt-[1vw]"></img>
                </div>
            </div>
            ...
            <div className="flex flex-col items-center mt-[4vw]">
                <div className="stream-section-heading">Small Optimization</div>
            </div>
            ...
            <div className="flex flex-col justify-center items-center">
                ...
                <div>
                    <img alt="Detection pipeline glimpse" src={bruteforce} className="   mt-[1vw]"></img>
                </div>
            </div>
