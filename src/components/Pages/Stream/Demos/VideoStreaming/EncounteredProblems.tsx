...
function EncounteredProblems() {
    ...
    return (
        ...
        <div className="encounteredProblems stream-article flex flex-col items-center">
            ...
            <div className='flex flex-col items-center mt-[0.4vw]'>
                ...
                <div className='text-[5vw] leading-[6vw] text-brand-emphasis'>
                    SIKEEE !
                </div>
                <div className='mt-3'>
                    {problems}
            ...
            <div className='flex flex-col items-center'>
                ...
                <div className='text-[2vw] leading-[2vw] text-brand-emphasis'>
            ...
            <div>
                ...
                <img alt="Completed thread collection diagram" src={outOfOrderFrames_foundThreads} className="w-[100%] h-auto rounded-3xl mt-4"></img>
            </div>
            ...
            <div>
                ...
                <img alt="Latest frame selection diagram" src={outOfOrderFrames_pickingThreads} className="w-[100%] h-auto rounded-3xl mt-4"></img>
            </div>
            ...
            <div>
                ...
                <div className='flex flex-col items-center'>
                    <div className='stream-code-pill pt-1 pb-2 px-5 mt-3'>
            ...
            <div>
                ...
                <div className='flex flex-col items-center'>
                    <div>
                        <div className='stream-code-pill pt-1 pb-2 px-5 mt-4'>
            ...
            <img alt="Delay chart showing stabilization" src={jitteryVideo_insaneDelay} className="w-[100%] h-auto rounded-3xl mt-4"></img>
