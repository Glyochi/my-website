...
function VideoStreamingBody() {
    ...
    return (
        ...
        >
            <div className="text-[2vw] text-cyan-400 mt-[1.2vw] ml-[6vw] w-full">Part 1</div>

            {/* ******************************************************************************************************************************* */}
            <div className="flex flex-row justify-center">
                <div className=" text-[4vw] text-cyan-400 ">Live Streaming Application</div>
            </div>

            {/* ******************************************************************************************************************************* */}
            <div className="grid grid-cols-7 bg-blue-700 rounded-[2vw] mt-3 w-[94%] p-[0.6vw] pb-[1vw]">
