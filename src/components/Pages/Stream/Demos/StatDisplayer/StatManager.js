...
class StatManager {
    constructor(displayLeftSideRef, displayRightSideRef) {
    ...
    drawOnDisplayer() {
        ...
        let avg_delay = (this.delayAverage).toFixed(2);
        let avg_var = (this.frameTimeVariationAverage).toFixed(2);
        let one_low = (this.onePercentLowSum / this.onePercentSize).toFixed(2);
        let one_high = (this.onePercentHighSum / this.onePercentSize).toFixed(2);
    ...
    findIndexBinary(value, start, end) {
