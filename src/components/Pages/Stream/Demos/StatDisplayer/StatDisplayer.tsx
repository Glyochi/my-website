...
function StatDisplayer(props: any, ref: any) {


    const onePercentLow = useRef<any>(null);
    const average = useRef<any>(null);
    const onePercentHigh = useRef<any>(null);
    const frameTimeVariation = useRef<any>(null);
