...
class CanvasArtist {
    ...
    draw_coordinates(base64_frame: string, frameID: number, faceCoordinates: any) {
        let img = new Image();
        ...
        img.onload = () => {
            ...
            if (faceCoordinates == null) {
                ...
                for (let i = 0; i < this.lastFaceInfo.length; i++) {
                    let face = this.lastFaceInfo[i]
            ...
            context.stroke();
            this.lastFaceInfo = faceCoordinates;
    ...
    enhanced_draw_coordinates(base64_frame: string, frameID: number, faceInfo: any) {
        let img = new Image();
        ...
        img.onload = () => {
            ...
            if (faceInfo == null) {
                ...
                context.strokeStyle = 'orange';
                for (let i = 0; i < this.lastFaceInfo.length; i++) {
                    let face = this.lastFaceInfo[i][0]
                    let leftEye = this.lastFaceInfo[i][1]
                    let rightEye = this.lastFaceInfo[i][2]
                    let angle = this.lastFaceInfo[i][3]
